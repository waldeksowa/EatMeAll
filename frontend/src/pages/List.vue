        ...
        <div>
            ...
            <div class="q-gutter-y-lg " v-for="m in meals" :key="m.id">
                ...
                <div class="col-grow col-shrink" v-for="(t,j) in 5" :key="j">
                    ...
                    <q-img :src="returnImgByMealTime(m.mealTime[j])" style="height:10vh">
                        <div class="absolute-full text-subtitle1 text-bold flex flex-center text-center " >
                        <q-tooltip>
                    ...
                    <q-card-section class="q-pt-md bg-grey-3 " >
                        ...
                        <q-chip :label="returnPreparationTime(m.prepareTime)" icon="timer">
                        <q-tooltip>
                        ...
                        <q-btn class="bg-primary text-white" round icon="visibility" @click="showDialog(m,m.mealTime[j])">
                            <q-tooltip>
                ...
                <q-card style="width:80vw; height:80vh"  class="q-pa-lg">
                    ...
                    <div class="q-col-gutter-y-lg q-mt-lg">
                        ...
                        <div class="text-body1 ">Węglowodany ({{dataSelectedDialog.carbohydrates}}/100)g</div>
                        <q-linear-progress stripe rounded size="20px" :value="calcValueforProgressBar(dataSelectedDialog.carbohydrates)" color="red" class="q-mt-sm" />
                        <div class="text-body1 ">Tłuszcze ({{dataSelectedDialog.fat}}/100)g</div>
                        <q-linear-progress stripe rounded size="20px" :value="calcValueforProgressBar(dataSelectedDialog.fat)" color="green" class="q-mt-sm" />
                        <div class="text-body1 ">Białko ({{dataSelectedDialog.protein}}/100)g</div>
                        <q-linear-progress stripe rounded size="20px" :value="calcValueforProgressBar(dataSelectedDialog.protein)" color="blue" class="q-mt-sm" />
