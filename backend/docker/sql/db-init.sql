...
CREATE TABLE public.shopping_list_items (
    ...
    CONSTRAINT fk_shopping_lists_items_shopping_list_id FOREIGN KEY (shopping_list_id)
        REFERENCES public.shopping_lists (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fk_shopping_list_items_product_id FOREIGN KEY (product_id)
        REFERENCES public.products (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
(	117	, current_timestamp, current_timestamp,0,	370.00	,	56.80	,	8.80	        ,'Szarłat (Amarantus)'	,	15.80	,	0.00	,	1	),
...
(	147	, current_timestamp, current_timestamp,0,	386.00	,	0.00	,	31.60	        ,'Ser Appenzeller, 50% tłuszczu'	,	25.40	,	0.00	,	2	),
(	148	, current_timestamp, current_timestamp,0,	229.00	,	0.00	,	17.00	        ,'Ser Back-Camembert, 45% tłuszczu'	,	19.00	,	0.00	,	2	),
(	149	, current_timestamp, current_timestamp,0,	413.00	,	0.00	,	40.00	        ,'Ser Bavaria Blue, 70% tłuszczu'	,	13.20	,	0.00	,	2	),
(	150	, current_timestamp, current_timestamp,0,	373.00	,	0.00	,	30.20	        ,'Ser Bel Paese'	,	25.40	,	0.00	,	2	),
(	151	, current_timestamp, current_timestamp,0,	358.00	,	0.00	,	29.60	        ,'Ser Bleu d’Auvergne, 50% tłuszczu'	,	22.90	,	0.00	,	2	),
(	152	, current_timestamp, current_timestamp,0,	358.00	,	0.00	,	29.60	        ,'Ser Bleu de Bresse, 50% tłuszczu'	,	22.90	,	0.00	,	2	),
(	153	, current_timestamp, current_timestamp,0,	413.00	,	0.00	,	40.00	        ,'Ser Cambozola, 70% tłuszczu'	,	13.20	,	0.00	,	2	),
(	154	, current_timestamp, current_timestamp,0,	334.00	,	1.00	,	24.90	        ,'Ser Edamski wędzony'	,	26.40	,	0.00	,	2	),
(	155	, current_timestamp, current_timestamp,0,	325.00	,	0.00	,	25.40	        ,'Ser Favorel, Danbo, 45% tłuszczu'	,	24.10	,	0.00	,	2	),
(	156	, current_timestamp, current_timestamp,0,	360.00	,	0.00	,	31.20	        ,'Ser Gorgonzola'	,	19.40	,	0.00	,	2	),
(	157	, current_timestamp, current_timestamp,0,	399.00	,	0.00	,	32.10	        ,'Ser Gruyère, 45% tłuszczu'	,	26.90	,	0.00	,	2	),
(	158	, current_timestamp, current_timestamp,0,	126.00	,	0.00	,	0.70	        ,'Ser Herceński, moguncki'	,	30.00	,	0.00	,	2	),
(	159	, current_timestamp, current_timestamp,0,	349.00	,	0.00	,	26.90	        ,'Ser Jarlsberg, 45% tłuszczu'	,	26.70	,	0.00	,	2	),
(	160	, current_timestamp, current_timestamp,0,	280.00	,	0.00	,	21.80	        ,'Ser kozi miękki, 45% tłuszczu'	,	21.00	,	0.00	,	2	),
(	161	, current_timestamp, current_timestamp,0,	329.00	,	0.00	,	27.00	        ,'Ser kozi w plasterkach, 48% tłuszczu'	,	21.60	,	0.00	,	2	),
(	162	, current_timestamp, current_timestamp,0,	352.00	,	0.00	,	27.60	        ,'Ser Leerdamski, 45% tłuszczu'	,	25.90	,	0.00	,	2	),
(	163	, current_timestamp, current_timestamp,0,	184.00	,	0.00	,	8.60	        ,'Ser Limburski, 20% tłuszczu'	,	26.40	,	0.00	,	2	),
(	164	, current_timestamp, current_timestamp,0,	268.00	,	0.00	,	19.70	        ,'Ser Limburski, 40% tłuszczu'	,	22.40	,	0.00	,	2	),
(	165	, current_timestamp, current_timestamp,0,	286.00	,	0.00	,	18.00	        ,'Ser Lindenberski lekki, 30% tłuszczu'	,	31.00	,	0.00	,	2	),
(	166	, current_timestamp, current_timestamp,0,	386.00	,	0.00	,	30.00	        ,'Ser Lindenberski, 45% tłuszczu'	,	28.90	,	0.00	,	2	),
(	167	, current_timestamp, current_timestamp,0,	355.00	,	0.00	,	29.60	        ,'Ser Maaslandzki, 50% tłuszczu'	,	22.20	,	0.00	,	2	),
(	168	, current_timestamp, current_timestamp,0,	460.00	,	3.60	,	47.50	        ,'Ser Mascarpone'	,	4.60	,	0.00	,	2	),
(	169	, current_timestamp, current_timestamp,0,	366.00	,	0.00	,	33.20	        ,'Ser miękki z zielonym pieprzem, 60% tłuszczu'	,	16.80	,	0.00	,	2	),
(	170	, current_timestamp, current_timestamp,0,	297.00	,	0.00	,	22.40	        ,'Ser Moorbier, 40% tłuszczu'	,	23.80	,	0.00	,	2	),
(	171	, current_timestamp, current_timestamp,0,	314.00	,	1.70	,	25.40	        ,'Ser owczy, Bryndza'	,	20.50	,	0.00	,	2	),
(	172	, current_timestamp, current_timestamp,0,	356.00	,	0.00	,	29.60	        ,'Ser Pirenejski, 50% tłuszczu'	,	22.30	,	0.00	,	2	),
(	173	, current_timestamp, current_timestamp,0,	355.00	,	0.00	,	29.80	        ,'Ser Pleśniowy, 60% tłuszczu'	,	21.10	,	0.00	,	2	),
(	174	, current_timestamp, current_timestamp,0,	365.00	,	0.00	,	28.90	        ,'Ser Provolone'	,	26.30	,	0.00	,	2	),
(	175	, current_timestamp, current_timestamp,0,	343.00	,	0.00	,	28.00	        ,'Ser Raclette, 48% tłuszczu'	,	22.70	,	0.00	,	2	),
(	176	, current_timestamp, current_timestamp,0,	333.00	,	1.90	,	33.00	        ,'Ser Robiola, 75% tłuszczu'	,	7.00	,	0.00	,	2	),
(	177	, current_timestamp, current_timestamp,0,	187.00	,	0.00	,	9.00	        ,'Ser Romadur, 20% tłuszczu'	,	26.40	,	0.00	,	2	),
(	178	, current_timestamp, current_timestamp,0,	226.00	,	0.00	,	14.10	        ,'Ser Romadur, 30% tłuszczu'	,	24.80	,	0.00	,	2	),
(	179	, current_timestamp, current_timestamp,0,	386.00	,	0.00	,	32.00	        ,'Ser Tête de Moine, 50% tłuszczu'	,	24.50	,	0.00	,	2	),
...
(	185	, current_timestamp, current_timestamp,0,	352.00	,	0.00	,	27.60	        ,'Ser Westberski, 45% tłuszczu'	,	25.90	,	0.00	,	2	),
...
(	275	, current_timestamp, current_timestamp,0,	381.00	,	0.00	,	37.00	        ,'Baranina, mostek'	,	12.00	,	0.00	,	4	),
(	276	, current_timestamp, current_timestamp,0,	112.00	,	0.00	,	3.40	        ,'Baranina, polędwica'	,	20.40	,	0.00	,	4	),
(	277	, current_timestamp, current_timestamp,0,	131.00	,	0.00	,	6.10	        ,'Baranina, sznycel'	,	19.10	,	0.00	,	4	),
(	278	, current_timestamp, current_timestamp,0,	232.00	,	0.00	,	18.00	        ,'Baranina, udziec'	,	18.00	,	0.00	,	4	),
(	279	, current_timestamp, current_timestamp,0,	98.00	,	0.00	,	1.60	        ,'Cielęcina, goleń'	,	20.90	,	0.00	,	4	),
(	280	, current_timestamp, current_timestamp,0,	106.00	,	0.00	,	2.80	        ,'Cielęcina, łopatka'	,	19.90	,	0.00	,	4	),
(	281	, current_timestamp, current_timestamp,0,	131.00	,	0.00	,	6.30	        ,'Cielęcina, mostek'	,	18.60	,	0.00	,	4	),
(	282	, current_timestamp, current_timestamp,0,	95.00	,	0.00	,	1.40	        ,'Cielęcina, polędwica'	,	20.60	,	0.00	,	4	),
...
(	286	, current_timestamp, current_timestamp,0,	99.00	,	0.00	,	3.40	        ,'Grasica cielęca'	,	17.20	,	0.00	,	4	),
...
(	297	, current_timestamp, current_timestamp,0,	194.00	,	0.00	,	13.20	        ,'Ozór barani'	,	18.70	,	0.00	,	4	),
...
(	387	, current_timestamp, current_timestamp,0,	896.00	,	0.00	,	99.50	        ,'Smalec gęsi'	,	0.00	,	0.00	,	7	),
...
(	390	, current_timestamp, current_timestamp,0,	11.00	,	0.00	,	0.20	        ,'Boczniaki'	,	2.30	,	5.90	,	8	),
...
(	393	, current_timestamp, current_timestamp,0,	18.00	,	0.00	,	0.60	        ,'Koźlarze'	,	3.10	,	6.50	,	8	),
...
(	419	, current_timestamp, current_timestamp,0,	520.00	,	54.00	,	28.00	        ,'Płatki arachidowe'	,	13.00	,	0.00	,	9	),
...
(	463	, current_timestamp, current_timestamp,0,	85.00	,	18.00	,	0.00	        ,'Jarzębina słodka, owoce'	,	1.50	,	2.40	,	10	),
...
(	467	, current_timestamp, current_timestamp,0,	64.00	,	14.60	,	0.30	        ,'Kumkwat, surowy'	,	0.60	,	0.00	,	10	),
(	468	, current_timestamp, current_timestamp,0,	75.00	,	17.00	,	0.30	        ,'Liczi (śliwa chińska)'	,	0.90	,	1.60	,	10	),
(	469	, current_timestamp, current_timestamp,0,	39.00	,	1.90	,	2.40	        ,'Limonka, surowa'	,	0.50	,	0.00	,	10	),
(	470	, current_timestamp, current_timestamp,0,	64.00	,	15.00	,	0.00	        ,'Malinojeżyny, surowe'	,	1.10	,	1.10	,	10	),
...
(	480	, current_timestamp, current_timestamp,0,	38.00	,	8.10	,	0.00	        ,'Morwa, całe owoce'	,	1.30	,	2.00	,	10	),
...
(	511	, current_timestamp, current_timestamp,0,	348.00	,	84.10	,	0.00	        ,'Guma arabska'	,	1.40	,	0.00	,	11	),
(	512	, current_timestamp, current_timestamp,0,	61.00	,	11.00	,	0.80	        ,'Imbir, świeży'	,	2.50	,	0.00	,	11	),
(	513	, current_timestamp, current_timestamp,0,	333.00	,	71.90	,	4.70	        ,'Imbir, mielony'	,	7.10	,	12.50	,	11	),
(	514	, current_timestamp, current_timestamp,0,	415.00	,	52.00	,	20.20	        ,'Kapary'	,	6.00	,	0.00	,	11	),
...
(	521	, current_timestamp, current_timestamp,0,	88.00	,	17.00	,	0.00	        ,'Ocet balsamiczny'	,	0.50	,	0.00	,	11	),
...
(	538	, current_timestamp, current_timestamp,0,	81.00	,	0.00	,	1.90	        ,'Homary'	,	15.90	,	0.00	,	12	),
(	539	, current_timestamp, current_timestamp,0,	73.00	,	0.00	,	0.90	        ,'Kalmary'	,	16.10	,	0.00	,	12	),
(	540	, current_timestamp, current_timestamp,0,	105.00	,	0.00	,	3.60	        ,'Karmazyn atlantycki'	,	18.20	,	0.00	,	12	),
(	541	, current_timestamp, current_timestamp,0,	110.00	,	0.00	,	4.20	        ,'Karp, świeży'	,	18.00	,	0.00	,	12	),
(	542	, current_timestamp, current_timestamp,0,	115.00	,	0.00	,	6.50	        ,'Kawior namiastka'	,	14.00	,	0.00	,	12	),
(	543	, current_timestamp, current_timestamp,0,	244.00	,	0.00	,	15.50	        ,'Kawior naturalny'	,	26.10	,	0.00	,	12	),
(	544	, current_timestamp, current_timestamp,0,	87.00	,	0.00	,	1.40	        ,'Kraby'	,	18.60	,	0.00	,	12	),
(	545	, current_timestamp, current_timestamp,0,	92.00	,	0.00	,	2.50	        ,'Kraby w puszce'	,	17.40	,	0.00	,	12	),
(	546	, current_timestamp, current_timestamp,0,	84.00	,	1.30	,	1.10	        ,'Langusta'	,	17.20	,	0.00	,	12	),
(	547	, current_timestamp, current_timestamp,0,	116.00	,	0.00	,	5.50	        ,'Leszcz'	,	16.60	,	0.00	,	12	),
(	548	, current_timestamp, current_timestamp,0,	77.00	,	0.00	,	0.70	        ,'Lin'	,	17.70	,	0.00	,	12	),
...
(	553	, current_timestamp, current_timestamp,0,	54.00	,	0.00	,	1.30	        ,'Małże – małgiew'	,	10.50	,	0.00	,	12	),
(	554	, current_timestamp, current_timestamp,0,	69.00	,	2.40	,	2.00	        ,'Małże – omułek jadalny'	,	10.50	,	0.00	,	12	),
(	555	, current_timestamp, current_timestamp,0,	87.00	,	0.00	,	1.70	        ,'Mięso raków, w puszkach'	,	18.00	,	0.00	,	12	),
...
(	565	, current_timestamp, current_timestamp,0,	64.00	,	0.00	,	0.50	        ,'Raki (rzeczne)'	,	15.00	,	0.00	,	12	),
...
(	572	, current_timestamp, current_timestamp,0,	100.00	,	0.00	,	3.20	        ,'Sieja'	,	17.80	,	0.00	,	12	),
...
(	586	, current_timestamp, current_timestamp,0,	82.00	,	0.00	,	1.70	        ,'Turbot'	,	16.70	,	0.00	,	12	),
(	587	, current_timestamp, current_timestamp,0,	77.00	,	0.00	,	0.60	        ,'Wątłusz/łupacz'	,	17.90	,	0.00	,	12	),
(	588	, current_timestamp, current_timestamp,0,	302.00	,	0.00	,	24.10	        ,'Wędzone płaty brzuszne rekina'	,	21.30	,	0.00	,	12	),
...
(	591	, current_timestamp, current_timestamp,0,	80.00	,	0.00	,	1.90	        ,'Zębacz'	,	15.80	,	0.00	,	12	),
(	592	, current_timestamp, current_timestamp,0,	21.00	,	6.30	,	0.10	        ,'Bakłażan'	,	1.10	,	2.50	,	13	),
(	593	, current_timestamp, current_timestamp,0,	17.00	,	1.00	,	0.30	        ,'Bambus, kiełki'	,	2.50	,	0.00	,	13	),
...
(	708	, current_timestamp, current_timestamp,0,	166.00	,	30.00	,	0.00	        ,'Likiery (ok. 30 procentowe)'	,	0.00	,	0.00	,	14	),
...
(	716	, current_timestamp, current_timestamp,0,	42.00	,	0.00	,	0.00	        ,'Piwo kolońskie'	,	0.40	,	0.00	,	14	),
...
(	723	, current_timestamp, current_timestamp,0,	240.00	,	2.00	,	0.00	        ,'Winiak'	,	0.00	,	0.00	,	14	),
...
(	730	, current_timestamp, current_timestamp,0,	74.00	,	5.00	,	0.00	        ,'Wino owocowe'	,	0.00	,	0.00	,	14	),
...
(	751	, current_timestamp, current_timestamp,0,	22.00	,	4.50	,	0.30	        ,'Sok z aceroli'	,	0.30	,	0.00	,	15	),
...
(	761	, current_timestamp, current_timestamp,0,	320.00	,	70.00	,	2.50	        ,'Budyń czekoladowy, w proszku'	,	4.50	,	0.00	,	16	),
(	762	, current_timestamp, current_timestamp,0,	346.00	,	86.00	,	0.00	        ,'Budyń waniliowy, śmietankowy, w proszku'	,	0.50	,	0.00	,	16	),
...
(	795	, current_timestamp, current_timestamp,0,	10.00	,	2.60	,	0.00	        ,'Guma do życia'	,	0.00	,	0.00	,	16	),
...
(	816	, current_timestamp, current_timestamp,0,	332.00	,	83.00	,	0.00	        ,'Kisiel owocowy, w proszku'	,	0.00	,	0.00	,	16	),
(	817	, current_timestamp, current_timestamp,0,	456.00	,	73.00	,	16.50	        ,'Krem czekoladowy, w proszku'	,	4.00	,	0.00	,	16	),
(	818	, current_timestamp, current_timestamp,0,	322.00	,	80.00	,	0.00	        ,'Krem owocowy, w proszku'	,	0.50	,	0.00	,	16	),
(	819	, current_timestamp, current_timestamp,0,	401.00	,	69.50	,	13.00	        ,'Krem waniliowy, w proszku'	,	1.50	,	0.00	,	16	),
(	820	, current_timestamp, current_timestamp,0,	127.00	,	20.00	,	3.00	        ,'Lody mleczne'	,	5.00	,	0.00	,	16	),
(	821	, current_timestamp, current_timestamp,0,	115.00	,	19.00	,	3.00	        ,'Lody mleczno-owocowe'	,	3.00	,	0.00	,	16	),
(	822	, current_timestamp, current_timestamp,0,	80.00	,	20.00	,	0.00	        ,'Lody owocowe'	,	0.00	,	0.00	,	16	),
(	823	, current_timestamp, current_timestamp,0,	220.00	,	15.00	,	17.00	        ,'Lody śmietankowe'	,	2.00	,	0.00	,	16	),
...
(	829	, current_timestamp, current_timestamp,0,	500.00	,	66.00	,	24.00	        ,'Nugat'	,	5.00	,	0.00	,	16	),
(	830	, current_timestamp, current_timestamp,0,	528.00	,	58.40	,	31.00	        ,'Pasta orzechowa do chleba'	,	4.00	,	0.00	,	16	),
